export default function GradientBorder({ children, className = "", compact = false }) {
  return (
    <div className={`relative rounded-2xl p-[2px] ${className}`}>
      ...
      <div className={`relative z-10 rounded-2xl bg-gray-950/90 backdrop-blur-sm ${compact ? "p-2 md:p-3" : "p-6 md:p-8"}`}>
        {children}
      </div>
    </div>
  );
